...
author: "fatimah, annie, GLDDPJ, Apollo0417, Echo and Lisa - FAGAEL"
date: "`r Sys.Date()`"
...
widw formate data has values that do not repeat in the first column while long format data has values repeats in the first column.
